export const profile = (
  <svg width="3rem" height="3rem" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
...
export const lang = (
  <svg width="3rem" height="3rem" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="25" y="17" width="1" height="1" fill="currentColor" />
...
export const resume = (
  <svg width="3rem" height="3rem" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="8" y="23" width="1" height="1" fill="currentColor" />
    <rect x="23" y="23" width="1" height="1" fill="currentColor" />
    <rect x="8" y="24" width="1" height="1" fill="currentColor" />
    <rect x="11" y="24" width="1" height="1" fill="currentColor" />
...
export const ts = (<svg width="4rem" height="4rem" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
  ...
  <rect x="17" y="7" width="1" height="1" fill="currentColor" />
  ...
  <rect x="8" y="23" width="1" height="1" fill="currentColor" />
  <rect x="23" y="23" width="1" height="1" fill="currentColor" />
  <rect x="9" y="24" width="1" height="1" fill="currentColor" />
  <rect x="10" y="24" width="1" height="1" fill="currentColor" />
  <rect x="11" y="24" width="1" height="1" fill="currentColor" />
  <rect x="12" y="24" width="1" height="1" fill="currentColor" />
  <rect x="13" y="24" width="1" height="1" fill="currentColor" />
  <rect x="14" y="24" width="1" height="1" fill="currentColor" />
...
export const c = (
  <svg width="4rem" height="4rem" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
  <rect x="9" y="7" width="1" height="1" fill="currentColor"/>
  <rect x="10" y="7" width="1" height="1" fill="currentColor"/>
  <rect x="11" y="7" width="1" height="1" fill="currentColor"/>
  <rect x="12" y="7" width="1" height="1" fill="currentColor"/>
...
export const defaultIcon = (
  ...
  <rect x="7" y="22" width="1" height="1" fill="currentColor"/>
  <rect x="24" y="22" width="1" height="1" fill="currentColor"/>
  <rect x="7" y="23" width="1" height="1" fill="currentColor"/>
  <rect x="8" y="23" width="1" height="1" fill="currentColor"/>
